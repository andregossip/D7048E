...
def go_down():
    if head.direction != "up" and head.direction != "pause":
        head.direction = "down"

def go_left():
    if head.direction != "right" and head.direction != "pause":
        head.direction = "left"

def go_right():
    if head.direction != "left" and head.direction != "pause":
